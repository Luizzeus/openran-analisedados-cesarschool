...
| 3 | SMO/OAM + IA | Adicionar plano de gestao, O1 simulado, snapshots e rApp experimental KPM -> policy A1 | Reusa Fase 2 | Reusa Fase 2; envio opt-in | SMO-lite local ou SMO OAM externo | Base e fluxo IA implementados |
